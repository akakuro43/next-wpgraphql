                ...
                <section class="s-tagSingle">
                  ...
                  ?>
                    <div class="c-main-inner">
                      <h2 class="tagSingle__ttl">
                        <span class="txt"># <?php single_tag_title(); ?></span>
                      </h2>
                    </div>
                    <div class="c-tabarea">
                      <ul class="tabs tabs--<?php echo $contentsType; ?>">
                        <li class="tab tab--all"><a class="link" href="/tag/<?php echo $tagSlug; ?>">全て</a></li>
                        <li class="tab tab--article"><a class="link" href="/tag/<?php echo $tagSlug; ?>?type=article">記事</a></li>
                        <li class="tab tab--video"><a class="link" href="/tag/<?php echo $tagSlug; ?>?type=video">動画</a></li>
                        <li class="tab tab--radio"><a class="link" href="/tag/<?php echo $tagSlug; ?>?type=radio">ラジオ</a></li>
                        <li class="tab tab--event"><a class="link" href="/tag/<?php echo $tagSlug; ?>?type=event">イベント</a></li>
                      </ul>
                    </div>
